...
<html>
	<head>
	    ...
	    <title>Kids Bikes | Bike Masters</title>
        ...
        <script src="js/content/kids_content.js"></script>
...
================================================== -->
    <div class="container">
        ...
        <!-- Giant Brand -->
        <div class="container">
            <h2 class="page-header">Giant Kids Bikes</h2>
        </div>
        ...
        <!-- Liv Brand -->
        <div class="container">
            <h2 class="page-header">Liv Kids Bikes</h2>
        </div>
...
<!-- MUST STAY ON THE BOTTOM -->
        ...
        <script>
			...
			if (buttonID == "btn-giant") {
			   $("#giant-dialog" + buttonVal).load('kids_content.php', {num : buttonVal, id : buttonID})
            }
			if (buttonID == "btn-liv"){
			   $("#liv-dialog" + buttonVal).load('kids_content.php', {num : buttonVal, id : buttonID})
            }
        })
        </script>
