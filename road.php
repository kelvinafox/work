...
<html>
	<head>
	    ...
	    <title>On-Road Bikes | Bike Masters</title>
        ...
        <script src="js/content/road_content.js"></script>
...
================================================== -->
    <div class="container">
        ...
        <!-- Giant Brand -->
        <div class="container">
            <h2 class="page-header">Giant On-Road Bikes</h2>
        </div>
        ...
        <!-- Liv Brand -->
        <div class="container">
            <h2 class="page-header">Liv On-Road Bikes</h2>
        </div>
...
<!-- MUST STAY ON THE BOTTOM -->
        ...
        <script>
			...
			if (buttonID == "btn-giant") {
			   $("#giant-dialog" + buttonVal).load('road_content.php', {num : buttonVal, id : buttonID})
            }
			if (buttonID == "btn-liv"){
			   $("#liv-dialog" + buttonVal).load('road_content.php', {num : buttonVal, id : buttonID})
            }
        })
        </script>
