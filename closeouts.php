...
<html>
	<head>
	    ...
	    <title>Bike Closeouts | Bike Masters</title>
...
================================================== -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Bike Closeouts</h1>
                <ol class="breadcrumb">
                    <li><a href="index.html">Home</a>
                    </li>
                    <li class="active">Bike Closeouts</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                ...
                <p>
                    ...
                    <h3 style="color:red;">Now $4999</h3>
                </p>
                <br>
                <hr>
            </div>
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                ...
                <p>
                    ...
                    <h3 style="color:red;">Now $1599</h3>
                </p>
                <br>
                <hr>
            </div>
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                ...
                <p>
                    ...
                    <h3 style="color:red;">Now $1600</h3>
                </p>
                <br>
                <hr>
            </div>
        ...
        <div class="row">
            <div class="col-sm-12 text-center">
                ...
                <p>
                    ...
                    <h3 style="color:red;">Now $1350</h3>
                </p>
                <br>
                <hr>
            </div>
